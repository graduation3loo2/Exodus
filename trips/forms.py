...
class SearchForm(forms.Form):
    ...
    price = forms.FloatField(required=False, widget=forms.NumberInput(attrs={'placeholder': 'From...'}))
    price2 = forms.FloatField(required=False, widget=forms.NumberInput(attrs={'placeholder': 'To..'}), label='')
